			...
			<div className="db-wrapper bg-ash overflow-hidden">
				<div className="db-sidebar transition">
					...
					<ul className="db-sidebar-menu list-unstyled mb-0">
						...
						<li
							className={`menu-item has-dropdown position-relative ${
								activeIndex === 0 ? 'active' : ''
							}`}>
							<span
								className="parent transition"
								onClick={() => handleToggle(0)}>
								<i className="fa-solid fa-house-crack"></i> &nbsp;Health
								Insurance
							</span>
							<ul
								...
								<li className="dropdown-item position-relative fs-14">
									<Link to="user_plans">
										Your Health Insurance Demo Health Plans
									</Link>
								</li>
								<li className="dropdown-item position-relative fs-14">
						...
						<li
							...
							<ul
								...
								<li className="dropdown-item position-relative fs-14">
									<Link to="book_appointment_out_pocket">
						...
						<li
							...
							<span
								...
								<i className="fa-solid fa-user-doctor"></i> &nbsp;Talk to Health
								Insurance Demo Doctor
							</span>
							<ul
								className="dropdown list-unstyled mb-0"
								...
								<li className="dropdown-item position-relative fs-14">
									<Link to="talk_doctor">
										Talk to Health Insurance Demo Doctor
									</Link>
								</li>
								<li className="dropdown-item position-relative fs-14">
